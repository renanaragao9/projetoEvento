                ...
                <tbody>
                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href=" <?php echo e(route('editarEvento', $event->id)); ?>" class="btn btn-info edit-btn" id="dash-button"><ion-icon name="create-outline"></ion-icon>Editar</a> 
                                
                                <?php if($event->private == 0): ?>
                                    <a href=" <?php echo e(route('events.pendingRequests', $event->id)); ?>" class="btn btn-dark aproved-btn" id="dash-button"><ion-icon name="create-outline"></ion-icon>Ver Aprovações</a> 
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/izadora/Documentos/Outros Projetos/projetoEvento/resources/views/events/dashboard.blade.php ENDPATH**/ ?>