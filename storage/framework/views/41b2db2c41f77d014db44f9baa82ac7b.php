                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <?php if(isset($images[0])): ?>
                            <img src="<?php echo e(asset('img/events/' . $images[0])); ?>" class="card-img-top" alt="<?php echo e($event->title); ?>">
                        <?php endif; ?>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <a href="<?php echo e(route('verEvento', $event->id)); ?>" class="btn btn-primary mt-auto" id="card-button">Saber Mais</a>
                        </div>
                    </div>
                </div>
