...
-- Copiando dados para a tabela hdcevents.events: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela hdcevents.event_user: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela hdcevents.migrations: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela hdcevents.sessions: ~1 rows (aproximadamente)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('wQqFpsdUHvBtmPKgZe2xMBJguNhzJiKCnzpDvo8g', 1, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1716231243);
